...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/export-download', [DatabaseBackupController::class, 'exportAndDownload'])
        ->name('db-backup.export-download')
        ->middleware('auth');
    ...
    Route::get('/import', [DatabaseBackupController::class, 'importPage'])
        ->name('db-backup.import-page')
        ->middleware('auth');
    ...
    Route::get('/download/{file}', [DatabaseBackupController::class, 'download'])
        ->name('db-backup.download')
        ->middleware('auth');
    
    Route::get('/delete/{file}', [DatabaseBackupController::class, 'delete'])
