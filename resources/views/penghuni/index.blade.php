...
@section('content')
    ...
    <div class="mt-6 flex items-center gap-3">
        <span class="text-sm font-medium text-gray-700 whitespace-nowrap">Pencadangan dan Pemulihan Database:</span>
        <div class="flex gap-2">
            <a href="{{ route('db-backup.import') }}" 
               class="flex items-center gap-2 bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 transition-all"
